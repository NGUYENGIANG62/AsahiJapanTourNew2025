...
const enTranslations = {
  ...
  calculator: {
    specialServices: {
      ...
      description: 'Select the special services you want to add to your tour. The cost of these services is not included in the quote and will be notified separately.',
      importantNote: 'Important note',
      importantNoteText: 'All services below are NOT included in the tour quote. The company will contact you directly to advise and quote for these additional services.',
    ...
    flight_details_description: 'Please provide your flight arrival and departure information for better planning',
    flight_time_note: 'Your flight times affect meal plans and transportation arrangements. Please select the appropriate options.',
    arrival_time: 'Arrival Time',
    arrival_time_help: 'When does your flight arrive in Japan?',
    morning_arrival: 'Morning Arrival (before 12:00)',
    morning_arrival_description: 'Includes lunch, dinner and full-day tour service',
    afternoon_arrival: 'Afternoon Arrival (after 12:00)',
    afternoon_arrival_description: 'Includes dinner only and airport transfer service',
    unknown_arrival: 'Unknown / Not decided yet',
    unknown_arrival_description: 'Calculate based on the full day',
    departure_time: 'Departure Time',
    departure_time_help: 'When does your flight leave Japan?',
    morning_departure: 'Morning Departure (before 12:00)',
    morning_departure_description: 'Includes hotel breakfast only',
    afternoon_departure: 'Afternoon Departure (after 12:00)',
    afternoon_departure_description: 'Includes hotel breakfast and lunch',
    unknown_departure: 'Unknown / Not decided yet',
    unknown_departure_description: 'Calculate based on the full day',
