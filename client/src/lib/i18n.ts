...
const enTranslations = {
  leoKnowledge: {
    title: 'Leo Knowledge Base',
    description: 'Manage the Leo AI assistant knowledge base, including FAQ, tour information, and local insights.',
    status: 'Knowledge Base Status',
    statusDescription: 'Check the status of the Leo knowledge base and upload sample data if needed.',
    currentStatus: 'Current status',
    checking: 'Checking...',
    available: 'Available',
    unavailable: 'Unavailable',
    availableTitle: 'Knowledge Base Ready',
    availableDesc: 'Leo knowledge base is connected and ready to use. Leo can now provide accurate information about tours and travel tips.',
    unavailableTitle: 'Knowledge Base Not Available',
    unavailableDesc: 'Leo knowledge base is not connected or needs to be initialized with data.',
    checkAgain: 'Check Again',
    uploadSampleData: 'Upload Sample Data',
    uploading: 'Uploading...',
    uploadSuccess: 'Data Uploaded Successfully',
    uploadSuccessDesc: 'Sample data has been successfully uploaded to the Leo knowledge base.',
    uploadError: 'Upload Failed',
    uploadErrorDesc: 'Failed to upload sample data. Please check your connection and permissions.',
    statusError: 'Status Check Failed',
    statusErrorDesc: 'Failed to check knowledge base status. Please try again later.',
    googleSheetInfo: 'Google Sheet Information',
    googleSheetInfoDesc: 'The Leo knowledge base is stored in a Google Sheet with the following structure:',
    googleSheetUrl: 'Google Sheet URL',
    faqSheet: 'FAQ Sheet',
    faqSheetDesc: 'Contains frequently asked questions and answers about Japan tours.',
    tourSheet: 'Tours Sheet',
    tourSheetDesc: 'Contains detailed information about available tours, including durations and highlights.',
    localInsightSheet: 'Local Insights Sheet',
    localInsightSheetDesc: 'Contains local tips and regional information about various destinations in Japan.',
  },
  common: {
    ...
    refresh: 'Refresh',
    welcomeMessage: 'Welcome to AsahiJapanTours',
    welcomeDescription: 'Thank you for choosing our services. We are committed to providing you with the best Japan travel experience!',
    preferredLocations: 'Preferred Locations',
    tourFor: 'Tour for',
    pricePerPerson: 'Price per person',
    tourExceedsDuration: 'Your selected days ({days} days) exceeds the standard tour duration ({standardDays} days). Please enter the places you want to visit in the "Preferred Locations" field.',
    startMessage: 'Thank you for your interest in our tour services. Start by selecting dates for your trip!',
    fullName: 'Full Name',
    age: 'Age',
    phone: 'Phone',
    email: 'Email',
    regularSeason: 'Regular Season',
    regularSeasonDescription: 'You have selected dates during the regular travel season. Standard rates apply.',
  ...
  auth: {
    ...
    fieldRequired: 'ID and password are required fields.',
  ...
  calculator: {
    specialServices: {
      title: 'Optional Services (Optional)',
      description: 'Please select special services you would like to add to your tour. The cost of these services is not included in the quote and will be communicated separately.',
      importantNote: 'Important Note',
      importantNoteText: 'All services below are NOT included in the tour price. We will contact you directly to provide advice and quotes for these additional services.',
      geishaShow: 'Geisha Show',
      kimonoExperience: 'Kimono Experience',
      teaCeremony: 'Traditional Tea Ceremony',
      wagyuDinner: 'Wagyu Beef Dinner',
      sumoShow: 'Sumo Show',
      disneylandTickets: 'Disneyland Tickets',
      universalStudioTickets: 'Universal Studio Tickets',
      airportTransfer: 'Airport Transfer Service',
      notes: 'Additional Notes',
      notesPlaceholder: 'Add special requests or questions about additional services...'
    },
    steps: {
      dates: 'Dates',
      services: 'Services',
    ...
    flight_details_description: 'Provide your flight arrival and departure information for better planning',
    flight_time_note: 'Your flight times affect meal planning and transportation arrangements. Please choose the appropriate option.',
    arrival_time: 'Arrival Time',
    arrival_time_help: 'When will you arrive in Japan?',
    morning_arrival: 'Morning Arrival (before 12:00)',
    morning_arrival_description: 'Includes lunch, dinner, and full-day tour services',
    afternoon_arrival: 'Afternoon Arrival (after 12:00)',
    afternoon_arrival_description: 'Only includes dinner and airport transfer service',
    unknown_arrival: 'Unknown / Not yet decided',
    unknown_arrival_description: 'Calculated for full day',
    departure_time: 'Departure Time',
    departure_time_help: 'When will you leave Japan?',
    morning_departure: 'Morning Departure (before 12:00)',
    morning_departure_description: 'Only includes hotel breakfast',
    afternoon_departure: 'Afternoon Departure (after 12:00)',
    afternoon_departure_description: 'Includes hotel breakfast and lunch',
    unknown_departure: 'Unknown / Not yet decided',
    unknown_departure_description: 'Calculated for full day',
    ...
    guide: {
      ...
      age: 'Age',
      yearsOld: 'years old',
      description: 'A guide will accompany your group throughout the trip, helping with translation, cultural context, and local information.'
    },
    summary: {
      ...
      preferredLocations: 'Preferred Locations',
      pleaseEnterLocations: 'Please enter places you would like to visit during the tour',
      pricePerPerson: 'Price per person:',
      tourForPeople: 'Tour for',
      daysExceeded: 'Your selected days',
      exceedsTourDays: 'exceed the standard tour days'
    }
  },
  languages: {
    en: 'English',
  ...
  sync: {
    ...
    note: 'Important Note',
    noteDescription: 'Always ensure you have a stable internet connection when syncing data. Incomplete syncs can lead to data inconsistencies.',
    ...
    errorFetchingStatus: 'Error fetching sync status',
    exportLanguage: 'Export Language',
    exportLanguageHelp: 'Choose the content language when exporting to Google Sheets.',
...
const jaTranslations = {
  calculator: {
    specialServices: {
      title: 'オプショナルサービス (任意)',
      description: 'ツアーに追加したい特別なサービスを選択してください。これらのサービスの費用は見積もりに含まれておらず、別途お知らせします。',
      importantNote: '重要な注意事項',
      importantNoteText: '以下のすべてのサービスはツアー料金に含まれていません。当社が直接ご連絡し、これらの追加サービスについてアドバイスと見積もりを提供します。',
      geishaShow: '芸者ショー',
      kimonoExperience: '着物体験',
      teaCeremony: '伝統的な茶道',
      wagyuDinner: '和牛ディナー',
      sumoShow: '相撲観戦',
      disneylandTickets: 'ディズニーランドチケット',
      universalStudioTickets: 'ユニバーサルスタジオチケット',
      airportTransfer: '空港送迎サービス',
      notes: '追加メモ',
      notesPlaceholder: '追加サービスに関する特別なリクエストや質問を追加してください...'
    },
    steps: {
      dates: '日付',
      services: 'サービス',
    ...
    flight_details: 'フライト情報',
    flight_details_description: '計画のためにフライトの到着と出発の情報をご提供ください',
    flight_time_note: 'フライト時間は食事プランと交通手段の手配に影響します。適切なオプションを選択してください。',
    arrival_time: '到着時間',
    arrival_time_help: 'いつ日本に到着しますか？',
    morning_arrival: '午前到着 (12:00以前)',
    morning_arrival_description: '昼食、夕食、終日ツアーサービスが含まれます',
    afternoon_arrival: '午後到着 (12:00以降)',
    afternoon_arrival_description: '夕食と空港送迎サービスのみ含まれます',
    unknown_arrival: '不明 / まだ決まっていない',
    unknown_arrival_description: '終日計算で対応します',
    departure_time: '出発時間',
    departure_time_help: 'いつ日本を出発しますか？',
    morning_departure: '午前出発 (12:00以前)',
    morning_departure_description: 'ホテルの朝食のみ含まれます',
    afternoon_departure: '午後出発 (12:00以降)',
    afternoon_departure_description: 'ホテルの朝食と昼食が含まれます',
    unknown_departure: '不明 / まだ決まっていない',
    unknown_departure_description: '終日計算で対応します',
...
const zhTranslations = {
  calculator: {
    specialServices: {
      title: '可选服务（选填）',
      description: '请选择您想要添加到旅行中的特别服务。这些服务的费用不包含在报价中，我们会另行通知。',
      importantNote: '重要提示',
      importantNoteText: '以下所有服务均不包含在旅行费用中。我们将直接与您联系，就这些额外服务提供建议和报价。',
      geishaShow: '艺伎表演',
      kimonoExperience: '和服体验',
      teaCeremony: '传统茶道',
      wagyuDinner: '和牛晚餐',
      sumoShow: '相扑表演',
      disneylandTickets: '迪士尼乐园门票',
      universalStudioTickets: '环球影城门票',
      airportTransfer: '机场接送服务',
      notes: '附加备注',
      notesPlaceholder: '请添加关于额外服务的特殊要求或问题...'
    },
    steps: {
      dates: '日期',
      services: '服务',
    ...
    flight_details: '航班信息',
    flight_details_description: '请提供您的航班到达和出发信息以便更好地规划',
    flight_time_note: '您的航班时间会影响餐饮计划和交通安排。请选择合适的选项。',
    arrival_time: '到达时间',
    arrival_time_help: '您的航班何时到达日本？',
    morning_arrival: '上午到达（12:00之前）',
    morning_arrival_description: '包含午餐、晚餐和全天旅游服务',
    afternoon_arrival: '下午到达（12:00之后）',
    afternoon_arrival_description: '仅包含晚餐和机场接送服务',
    unknown_arrival: '未知 / 尚未决定',
    unknown_arrival_description: '根据全天计算',
    departure_time: '出发时间',
    departure_time_help: '您的航班何时离开日本？',
    morning_departure: '上午出发（12:00之前）',
    morning_departure_description: '仅包含酒店早餐',
    afternoon_departure: '下午出发（12:00之后）',
    afternoon_departure_description: '包含酒店早餐和午餐',
    unknown_departure: '未知 / 尚未决定',
    unknown_departure_description: '根据全天计算',
...
const koTranslations = {
  calculator: {
    specialServices: {
      title: '선택적 서비스 (선택 사항)',
      description: '여행에 추가하고 싶은 특별 서비스를 선택하세요. 이러한 서비스의 비용은 견적에 포함되지 않으며 별도로 안내해 드립니다.',
      importantNote: '중요 안내사항',
      importantNoteText: '아래의 모든 서비스는 여행 요금에 포함되어 있지 않습니다. 저희가 직접 연락하여 이러한 추가 서비스에 대한 조언과 견적을 제공해 드립니다.',
      geishaShow: '게이샤 쇼',
      kimonoExperience: '기모노 체험',
      teaCeremony: '전통 차 예절',
      wagyuDinner: '와규 저녁 식사',
      sumoShow: '스모 관람',
      disneylandTickets: '디즈니랜드 티켓',
      universalStudioTickets: '유니버설 스튜디오 티켓',
      airportTransfer: '공항 이동 서비스',
      notes: '추가 메모',
      notesPlaceholder: '추가 서비스에 대한 특별 요청이나 질문을 추가하세요...'
    },
    steps: {
      dates: '날짜',
      services: '서비스',
    ...
    flight_details: '항공 정보',
    flight_details_description: '더 나은 계획을 위해 항공편 도착 및 출발 정보를 제공해 주세요',
    flight_time_note: '항공편 시간은 식사 계획 및 교통편 배정에 영향을 미칩니다. 알맞은 옵션을 선택해 주세요.',
    arrival_time: '도착 시간',
    arrival_time_help: '언제 일본에 도착할 예정인가요?',
    morning_arrival: '오전 도착 (12:00 이전)',
    morning_arrival_description: '점심, 저녁 식사 및 종일 투어 서비스 포함',
    afternoon_arrival: '오후 도착 (12:00 이후)',
    afternoon_arrival_description: '저녁 식사 및 공항 이동 서비스만 포함',
    unknown_arrival: '모름 / 아직 결정되지 않음',
    unknown_arrival_description: '종일 기준으로 계산',
    departure_time: '출발 시간',
    departure_time_help: '언제 일본을 떠날 예정인가요?',
    morning_departure: '오전 출발 (12:00 이전)',
    morning_departure_description: '호텔 아침 식사만 포함',
    afternoon_departure: '오후 출발 (12:00 이후)',
    afternoon_departure_description: '호텔 아침 식사 및 점심 식사 포함',
    unknown_departure: '모름 / 아직 결정되지 않음',
    unknown_departure_description: '종일 기준으로 계산',
...
const viTranslations = {
  calculator: {
    specialServices: {
      title: 'Dịch vụ tùy chọn (tùy chọn)',
      description: 'Vui lòng chọn các dịch vụ đặc biệt mà bạn muốn thêm vào tour. Chi phí của các dịch vụ này không được bao gồm trong báo giá và sẽ được thông báo riêng.',
      importantNote: 'Lưu ý quan trọng',
      importantNoteText: 'Tất cả các dịch vụ dưới đây KHÔNG bao gồm trong giá tour. Chúng tôi sẽ liên hệ trực tiếp với bạn để tư vấn và báo giá cho các dịch vụ bổ sung này.',
      geishaShow: 'Biểu diễn Geisha',
      kimonoExperience: 'Trải nghiệm mặc Kimono',
      teaCeremony: 'Lễ trà đạo truyền thống',
      wagyuDinner: 'Bữa tối bò Wagyu',
      sumoShow: 'Xem đấu Sumo',
      disneylandTickets: 'Vé Disneyland',
      universalStudioTickets: 'Vé Universal Studio',
      airportTransfer: 'Dịch vụ đưa đón sân bay',
      notes: 'Ghi chú bổ sung',
      notesPlaceholder: 'Thêm yêu cầu đặc biệt hoặc câu hỏi về các dịch vụ bổ sung...'
    },
    steps: {
      dates: 'Ngày',
      services: 'Dịch vụ',
    ...
    flight_details: 'Lịch bay',
    flight_details_description: 'Cung cấp lịch bay để chúng tôi phục vụ bạn tốt hơn',
    flight_time_note: 'Giờ bay ảnh hưởng đến lịch ăn và phương tiện đi lại.',
    arrival_time: 'Giờ đến',
    arrival_time_help: 'Khi nào bạn đến Nhật Bản?',
    morning_arrival: 'Buổi sáng (trước 12:00)',
    morning_arrival_description: 'Bao gồm bữa trưa, tối và tour nguyên ngày',
    afternoon_arrival: 'Buổi chiều (sau 12:00)',
    afternoon_arrival_description: 'Chỉ bao gồm bữa tối và đón sân bay',
    unknown_arrival: 'Chưa xác định',
    unknown_arrival_description: 'Tính toán cho cả ngày',
    departure_time: 'Giờ về',
    departure_time_help: 'Khi nào bạn rời Nhật Bản?',
    morning_departure: 'Buổi sáng (trước 12:00)',
    morning_departure_description: 'Chỉ bao gồm bữa sáng tại khách sạn',
    afternoon_departure: 'Buổi chiều (sau 12:00)',
    afternoon_departure_description: 'Bao gồm bữa sáng và bữa trưa',
    unknown_departure: 'Chưa xác định',
    unknown_departure_description: 'Tính toán cho cả ngày',
  ...
  leoKnowledge: {
    title: 'Cơ sở dữ liệu Leo',
    description: 'Quản lý cơ sở dữ liệu cho trợ lý ảo Leo, bao gồm các câu hỏi thường gặp, thông tin tour và kiến thức địa phương.',
    status: 'Trạng thái cơ sở dữ liệu',
    statusDescription: 'Kiểm tra trạng thái cơ sở dữ liệu Leo và tải dữ liệu mẫu nếu cần.',
    currentStatus: 'Trạng thái hiện tại',
    checking: 'Đang kiểm tra...',
    available: 'Đã sẵn sàng',
    unavailable: 'Chưa sẵn sàng',
    availableTitle: 'Cơ sở dữ liệu đã sẵn sàng',
    availableDesc: 'Cơ sở dữ liệu Leo đã được kết nối và sẵn sàng sử dụng. Leo giờ đây có thể cung cấp thông tin chính xác về tour và các lời khuyên du lịch.',
    unavailableTitle: 'Cơ sở dữ liệu chưa sẵn sàng',
    unavailableDesc: 'Cơ sở dữ liệu Leo chưa được kết nối hoặc cần được khởi tạo với dữ liệu.',
    checkAgain: 'Kiểm tra lại',
    uploadSampleData: 'Tải dữ liệu mẫu',
    uploading: 'Đang tải lên...',
    uploadSuccess: 'Tải dữ liệu thành công',
    uploadSuccessDesc: 'Dữ liệu mẫu đã được tải lên cơ sở dữ liệu Leo thành công.',
    uploadError: 'Tải dữ liệu thất bại',
    uploadErrorDesc: 'Không thể tải dữ liệu mẫu. Vui lòng kiểm tra kết nối và quyền truy cập của bạn.',
    statusError: 'Kiểm tra trạng thái thất bại',
    statusErrorDesc: 'Không thể kiểm tra trạng thái cơ sở dữ liệu. Vui lòng thử lại sau.',
    googleSheetInfo: 'Thông tin Google Sheet',
    googleSheetInfoDesc: 'Cơ sở dữ liệu Leo được lưu trữ trong Google Sheet với cấu trúc sau:',
    googleSheetUrl: 'URL Google Sheet',
    faqSheet: 'Sheet FAQ',
    faqSheetDesc: 'Chứa các câu hỏi thường gặp và câu trả lời về tour Nhật Bản.',
    tourSheet: 'Sheet Tours',
    tourSheetDesc: 'Chứa thông tin chi tiết về các tour có sẵn, bao gồm thời gian và điểm nổi bật.',
    localInsightSheet: 'Sheet Local Insights',
    localInsightSheetDesc: 'Chứa các lời khuyên địa phương và thông tin vùng miền về các điểm đến tại Nhật Bản.',
  },
  common: {
    appName: 'AsahiJapanTours',
    login: 'Đăng nhập',
