...
const viTranslations = {
  ...
  calculator: {
    ...
    flight_details_description: 'Vui lòng cung cấp thông tin chuyến bay đến và đi để lập kế hoạch tốt hơn',
    flight_time_note: 'Thời gian bay của bạn ảnh hưởng đến kế hoạch bữa ăn và sắp xếp phương tiện đi lại. Vui lòng chọn các tùy chọn phù hợp.',
    arrival_time: 'Thời gian đến',
    arrival_time_help: 'Khi nào chuyến bay của bạn đến Nhật Bản?',
    morning_arrival: 'Đến buổi sáng (trước 12:00)',
    morning_arrival_description: 'Bao gồm bữa trưa, bữa tối và dịch vụ tour cả ngày',
    afternoon_arrival: 'Đến buổi chiều (sau 12:00)',
    afternoon_arrival_description: 'Chỉ bao gồm bữa tối và dịch vụ đón sân bay',
    unknown_arrival: 'Không xác định / Chưa quyết định',
    unknown_arrival_description: 'Tính toán dựa trên cả ngày',
    departure_time: 'Thời gian khởi hành',
    departure_time_help: 'Khi nào chuyến bay của bạn rời Nhật Bản?',
    morning_departure: 'Khởi hành buổi sáng (trước 12:00)',
    morning_departure_description: 'Chỉ bao gồm bữa sáng tại khách sạn',
    afternoon_departure: 'Khởi hành buổi chiều (sau 12:00)',
    afternoon_departure_description: 'Bao gồm bữa sáng và bữa trưa tại khách sạn',
    unknown_departure: 'Không xác định / Chưa quyết định',
    unknown_departure_description: 'Tính toán dựa trên cả ngày',
